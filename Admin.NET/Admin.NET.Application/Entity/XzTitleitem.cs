...
[SugarTable("xz_titleitem", "系统标题栏目")]
public partial class XzTitleitem : EntityBaseId
{
    /// <summary>
    /// 标题名称
    /// </summary>
    [SugarColumn(ColumnName = "name", ColumnDescription = "标题名称", Length = 50)]
    public virtual string? name { get; set; }
    
    /// <summary>
    /// 逗号分隔
    /// </summary>
    [SugarColumn(ColumnName = "img", ColumnDescription = "逗号分隔", Length = 300)]
