...
public class ConfigConst
{
    ...
    /// <summary>
    /// 星盘接口 AccessToken（从 sys_config 读取，P2 优先级）
    /// </summary>
    public const string XingpanAccessToken = "xingpan_access_token";

    /// <summary>
    /// 星盘运势接口（go.xingpan.vip / luck 系列）专用 AccessToken（从 sys_config 读取，P2 优先级）
    /// <para>与 <see cref="XingpanAccessToken"/>（老 48 个接口）分开，便于独立维护与轮换。</para>
    /// </summary>
    public const string XingpanLuckAccessToken = "xingpan_luck_access_token";
