...
import 'topic_select_controller.dart';

class TopicSelectPage extends GetView<TopicSelectController> {
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => TopicSelectController());
    return Scaffold(
      appBar: AppBar(title: Text('添加话题'), backgroundColor: Colors.white),
      body: Container(
