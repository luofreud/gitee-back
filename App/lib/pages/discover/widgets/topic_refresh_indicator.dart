...
class TopicRefreshIndicator extends StatefulWidget {
  ...
  const TopicRefreshIndicator({
    super.key,
    required this.child,
    this.onPullDownUpdate,
    this.onPullDownEnd,
    this.onScrollUpdate,
  ...
  const TopicRefreshIndicator.adaptive({
    super.key,
    required this.child,
    this.onPullDownUpdate,
    this.onPullDownEnd,
  ...
  const TopicRefreshIndicator.noSpinner({
    super.key,
    required this.child,
    this.onPullDownUpdate,
    this.onPullDownEnd,
  ...
  final Function(double value)? onPullDownUpdate;
  final Function()? onPullDownEnd;
  final Function(ScrollNotification notification)? onScrollUpdate;
  ...
  @override
  TopicRefreshIndicatorState createState() => TopicRefreshIndicatorState();
}

/// Contains the state for a [RefreshIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class TopicRefreshIndicatorState extends State<TopicRefreshIndicator>
    with TickerProviderStateMixin<TopicRefreshIndicator> {
  ...
  void _checkDragOffset(double containerExtent) {
    ...
    widget.onPullDownUpdate?.call(newValue);
