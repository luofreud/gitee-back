...
class ChatServiceXp extends StatefulWidget {
  final List? starData;

  const ChatServiceXp({super.key, this.starData});

  @override
  State<ChatServiceXp> createState() => _ChatServiceXpState();
}

class _ChatServiceXpState extends State<ChatServiceXp> {
  Archive? _archive;
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: const DecorationImage(
                    image: AssetImage('assets/images/chat_xp_bg.png'),
                    fit: BoxFit.fitWidth,
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      SelectArchive(
                        placeholder: '请选择档案',
                        placeholderColor: Color(0xffA8B2E6),
                      ...
                      FormTextfieldContainer(
                        ...
                        title: '以星盘提问',
                        hintText: '一次只能问一个问题哦~',
                        color1: Color(0xff73C6F2),
                        color2: Color(0xff2467F1),
                      ),
                      Row(
                        children: [
                          Expanded(
