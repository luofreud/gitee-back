...
class ChatServiceZhp extends StatefulWidget {
  final List? starData;

  const ChatServiceZhp({super.key, this.starData});

  @override
  State<ChatServiceZhp> createState() => _ChatServiceZhpState();
}

class _ChatServiceZhpState extends State<ChatServiceZhp> {
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: const DecorationImage(
                    image: AssetImage('assets/images/chat_zhp_bg.png'),
                    fit: BoxFit.fitWidth,
                  ...
                  child: Column(
                    ...
                    children: [
                      FormTextfieldContainer(
                        ...
                        title: '以智慧牌提问',
                        hintText: '一次只能问一个问题哦~',
                        color1: Color(0xffE6B8FF),
                        color2: Color(0xffB35BE3),
                      ),
                      Row(
                        children: [
                          Expanded(
