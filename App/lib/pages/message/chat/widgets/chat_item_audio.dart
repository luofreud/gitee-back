...
class ChatItemAudio extends StatefulWidget {
  final String? content;

  const ChatItemAudio({super.key, this.content});

  @override
  State<ChatItemAudio> createState() => _ChatItemAudioState();
}

class _ChatItemAudioState extends State<ChatItemAudio> {
