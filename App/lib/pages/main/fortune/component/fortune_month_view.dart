...
import 'fortune_month_controller.dart';

class FortuneMonthComponent extends GetView<FortuneMonthController> {
  final int archiveId;
  const FortuneMonthComponent({super.key, required this.archiveId});
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => FortuneMonthController());
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: controller.monthTabs.map((item) {
              return Expanded(
                child: GestureDetector(
                  ...
                  child: Obx(() {
                    final selected =
                        ...
                        controller.monthTabs.indexOf(item);
...
class _MonthMoodComponent extends StatelessWidget {
  const _MonthMoodComponent();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        spacing: 10,
        children: [
          Image.asset('assets/images/month_mood.png', width: 133, height: 30),
          const SizedBox(height: 5),
          Obx(() {
            final fortune = Get.find<FortuneMonthController>().todayFortune.value;
            return Row(
              spacing: 10,
              children: [
                Expanded(
