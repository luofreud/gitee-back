...
import 'tarot_detail_controller.dart';

class TarotDetailPage extends GetView<TarotDetailController> {
  const TarotDetailPage({super.key});
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => TarotDetailController());
    return Scaffold(
