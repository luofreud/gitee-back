...
import 'revenue_record_controller.dart';

class RevenueRecordPage extends GetView<RevenueRecordController> {
  const RevenueRecordPage({super.key});
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => RevenueRecordController());
