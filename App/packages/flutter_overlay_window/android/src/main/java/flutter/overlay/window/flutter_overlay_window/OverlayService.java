...
public class OverlayService extends Service implements View.OnTouchListener {
    ...
    public void onCreate() {
        ...
        android.util.Log.i("OverlayService", "enableSound value: " + WindowSetup.enableSound);
        ...
        if (WindowSetup.enableSound != null && WindowSetup.enableSound) {
    ...
    private void playNotificationSound() {
        try {
            ...
            android.media.Ringtone ringtone = android.media.RingtoneManager.getRingtone(this, soundUri);
            if (ringtone != null) {
                ringtone.play();
            }
        } catch (Exception e) {
            android.util.Log.e("OverlayService", "Error playing sound: " + e.getMessage());
        }
    }
    ...
    private void recreateNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (WindowSetup.enableSound != null && WindowSetup.enableSound) {
                android.net.Uri defaultSoundUri = android.provider.Settings.System.DEFAULT_NOTIFICATION_URI;
                android.media.AudioAttributes audioAttributes = new android.media.AudioAttributes.Builder()
                        .setUsage(android.media.AudioAttributes.USAGE_NOTIFICATION)
                        .setContentType(android.media.AudioAttributes.CONTENT_TYPE_SONIFICATION)
                        .build();
                serviceChannel.setSound(defaultSoundUri, audioAttributes);
            } else {
